...
function html_address(; kwargs...)
        ...
        return Component("html_address", "Address", "dash_html_components", available_props, wild_props; kwargs...)
end

html_address(children::Any; kwargs...) = html_address(;kwargs..., children = children)
