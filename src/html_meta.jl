...
function html_meta(; kwargs...)
        available_props = Symbol[:children, :id, :n_clicks, :n_clicks_timestamp, :key, :role, :charSet, :content, :httpEquiv, :name, :accessKey, :className, :contentEditable, :contextMenu, :dir, :draggable, :hidden, :lang, :spellCheck, :style, :tabIndex, :title, :loading_state]
        wild_props = Symbol[Symbol("data-"), Symbol("aria-")]
        return Component("html_meta", "Meta", "dash_html_components", available_props, wild_props; kwargs...)
end

html_meta(children::Any; kwargs...) = html_meta(;kwargs..., children = children)
