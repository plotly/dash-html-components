...
function html_span(; kwargs...)
        ...
        return Component("html_span", "Span", "dash_html_components", available_props, wild_props; kwargs...)
end

html_span(children::Any; kwargs...) = html_span(;kwargs..., children = children)
