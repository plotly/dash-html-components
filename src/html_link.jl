...
function html_link(; kwargs...)
        available_props = Symbol[:children, :id, :accessKey, :className, :contentEditable, :contextMenu, :crossOrigin, :dir, :draggable, :hidden, :href, :hrefLang, :integrity, :key, :lang, :loading_state, :media, :n_clicks, :n_clicks_timestamp, :referrerPolicy, :rel, :role, :sizes, :spellCheck, :style, :tabIndex, :title]
        wild_props = Symbol[Symbol("aria-"), Symbol("data-")]
        return Component("html_link", "Link", "dash_html_components", available_props, wild_props; kwargs...)
end

html_link(children::Any; kwargs...) = html_link(;kwargs..., children = children)
