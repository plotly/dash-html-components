...
function html_embed(; kwargs...)
        available_props = Symbol[:children, :id, :accessKey, :className, :contentEditable, :contextMenu, :dir, :draggable, :height, :hidden, :key, :lang, :loading_state, :n_clicks, :n_clicks_timestamp, :role, :spellCheck, :src, :style, :tabIndex, :title, :type, :width]
