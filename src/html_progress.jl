...
function html_progress(; kwargs...)
        available_props = Symbol[:children, :id, :n_clicks, :n_clicks_timestamp, :key, :role, :form, :max, :value, :accessKey, :className, :contentEditable, :contextMenu, :dir, :draggable, :hidden, :lang, :spellCheck, :style, :tabIndex, :title, :loading_state]
        wild_props = Symbol[Symbol("data-"), Symbol("aria-")]
        return Component("html_progress", "Progress", "dash_html_components", available_props, wild_props; kwargs...)
end

html_progress(children::Any; kwargs...) = html_progress(;kwargs..., children = children)
