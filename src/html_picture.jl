...
function html_picture(; kwargs...)
        ...
        return Component("html_picture", "Picture", "dash_html_components", available_props, wild_props; kwargs...)
end

html_picture(children::Any; kwargs...) = html_picture(;kwargs..., children = children)
