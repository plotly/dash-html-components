...
function html_option(; kwargs...)
        available_props = Symbol[:children, :id, :n_clicks, :n_clicks_timestamp, :key, :role, :disabled, :label, :selected, :value, :accessKey, :className, :contentEditable, :contextMenu, :dir, :draggable, :hidden, :lang, :spellCheck, :style, :tabIndex, :title, :loading_state]
        wild_props = Symbol[Symbol("data-"), Symbol("aria-")]
        return Component("html_option", "Option", "dash_html_components", available_props, wild_props; kwargs...)
end

html_option(children::Any; kwargs...) = html_option(;kwargs..., children = children)
