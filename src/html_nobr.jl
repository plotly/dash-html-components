...
function html_nobr(; kwargs...)
        ...
        return Component("html_nobr", "Nobr", "dash_html_components", available_props, wild_props; kwargs...)
end

html_nobr(children::Any; kwargs...) = html_nobr(;kwargs..., children = children)
