...
function html_tbody(; kwargs...)
        ...
        return Component("html_tbody", "Tbody", "dash_html_components", available_props, wild_props; kwargs...)
end

html_tbody(children::Any; kwargs...) = html_tbody(;kwargs..., children = children)
