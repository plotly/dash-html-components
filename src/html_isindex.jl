...
function html_isindex(; kwargs...)
        ...
        return Component("html_isindex", "Isindex", "dash_html_components", available_props, wild_props; kwargs...)
end

html_isindex(children::Any; kwargs...) = html_isindex(;kwargs..., children = children)
