...
function html_acronym(; kwargs...)
        ...
        return Component("html_acronym", "Acronym", "dash_html_components", available_props, wild_props; kwargs...)
end

html_acronym(children::Any; kwargs...) = html_acronym(;kwargs..., children = children)
