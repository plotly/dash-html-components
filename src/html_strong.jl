...
function html_strong(; kwargs...)
        ...
        return Component("html_strong", "Strong", "dash_html_components", available_props, wild_props; kwargs...)
end

html_strong(children::Any; kwargs...) = html_strong(;kwargs..., children = children)
