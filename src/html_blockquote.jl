...
function html_blockquote(; kwargs...)
        available_props = Symbol[:children, :id, :n_clicks, :n_clicks_timestamp, :key, :role, :cite, :accessKey, :className, :contentEditable, :contextMenu, :dir, :draggable, :hidden, :lang, :spellCheck, :style, :tabIndex, :title, :loading_state]
        wild_props = Symbol[Symbol("data-"), Symbol("aria-")]
        return Component("html_blockquote", "Blockquote", "dash_html_components", available_props, wild_props; kwargs...)
end

html_blockquote(children::Any; kwargs...) = html_blockquote(;kwargs..., children = children)
