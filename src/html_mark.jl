...
function html_mark(; kwargs...)
        ...
        return Component("html_mark", "Mark", "dash_html_components", available_props, wild_props; kwargs...)
end

html_mark(children::Any; kwargs...) = html_mark(;kwargs..., children = children)
