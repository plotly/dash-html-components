...
function html_figure(; kwargs...)
        ...
        return Component("html_figure", "Figure", "dash_html_components", available_props, wild_props; kwargs...)
end

html_figure(children::Any; kwargs...) = html_figure(;kwargs..., children = children)
