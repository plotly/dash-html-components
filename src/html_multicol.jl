...
function html_multicol(; kwargs...)
        ...
        return Component("html_multicol", "Multicol", "dash_html_components", available_props, wild_props; kwargs...)
end

html_multicol(children::Any; kwargs...) = html_multicol(;kwargs..., children = children)
