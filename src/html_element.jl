...
function html_element(; kwargs...)
        ...
        return Component("html_element", "Element", "dash_html_components", available_props, wild_props; kwargs...)
end

html_element(children::Any; kwargs...) = html_element(;kwargs..., children = children)
