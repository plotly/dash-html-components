...
function html_article(; kwargs...)
        ...
        return Component("html_article", "Article", "dash_html_components", available_props, wild_props; kwargs...)
end

html_article(children::Any; kwargs...) = html_article(;kwargs..., children = children)
