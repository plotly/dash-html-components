...
function html_frame(; kwargs...)
        ...
        return Component("html_frame", "Frame", "dash_html_components", available_props, wild_props; kwargs...)
end

html_frame(children::Any; kwargs...) = html_frame(;kwargs..., children = children)
