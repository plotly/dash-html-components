...
function html_ruby(; kwargs...)
        ...
        return Component("html_ruby", "Ruby", "dash_html_components", available_props, wild_props; kwargs...)
end

html_ruby(children::Any; kwargs...) = html_ruby(;kwargs..., children = children)
