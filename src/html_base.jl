...
function html_base(; kwargs...)
        available_props = Symbol[:children, :id, :accessKey, :className, :contentEditable, :contextMenu, :dir, :draggable, :hidden, :href, :key, :lang, :loading_state, :n_clicks, :n_clicks_timestamp, :role, :spellCheck, :style, :tabIndex, :target, :title]
