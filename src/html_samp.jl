...
function html_samp(; kwargs...)
        ...
        return Component("html_samp", "Samp", "dash_html_components", available_props, wild_props; kwargs...)
end

html_samp(children::Any; kwargs...) = html_samp(;kwargs..., children = children)
