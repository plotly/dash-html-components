...
function html_abbr(; kwargs...)
        ...
        return Component("html_abbr", "Abbr", "dash_html_components", available_props, wild_props; kwargs...)
end

html_abbr(children::Any; kwargs...) = html_abbr(;kwargs..., children = children)
