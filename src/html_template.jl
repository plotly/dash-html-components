...
function html_template(; kwargs...)
        ...
        return Component("html_template", "Template", "dash_html_components", available_props, wild_props; kwargs...)
end

html_template(children::Any; kwargs...) = html_template(;kwargs..., children = children)
