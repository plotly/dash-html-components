...
function html_progress(; kwargs...)
        available_props = Symbol[:children, :id, :accessKey, :className, :contentEditable, :contextMenu, :dir, :draggable, :form, :hidden, :key, :lang, :loading_state, :max, :n_clicks, :n_clicks_timestamp, :role, :spellCheck, :style, :tabIndex, :title, :value]
