...
function html_video(; kwargs...)
        available_props = Symbol[:children, :id, :accessKey, :autoPlay, :className, :contentEditable, :contextMenu, :controls, :crossOrigin, :dir, :draggable, :height, :hidden, :key, :lang, :loading_state, :loop, :muted, :n_clicks, :n_clicks_timestamp, :poster, :preload, :role, :spellCheck, :src, :style, :tabIndex, :title, :width]
