...
function html_marquee(; kwargs...)
        available_props = Symbol[:children, :id, :accessKey, :className, :contentEditable, :contextMenu, :dir, :draggable, :hidden, :key, :lang, :loading_state, :loop, :n_clicks, :n_clicks_timestamp, :role, :spellCheck, :style, :tabIndex, :title]
