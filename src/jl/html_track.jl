...
function html_track(; kwargs...)
        available_props = Symbol[:children, :id, :accessKey, :className, :contentEditable, :contextMenu, :default, :dir, :draggable, :hidden, :key, :kind, :label, :lang, :loading_state, :n_clicks, :n_clicks_timestamp, :role, :spellCheck, :src, :srcLang, :style, :tabIndex, :title]
