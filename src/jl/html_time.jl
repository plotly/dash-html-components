...
function html_time(; kwargs...)
        available_props = Symbol[:children, :id, :accessKey, :className, :contentEditable, :contextMenu, :dateTime, :dir, :draggable, :hidden, :key, :lang, :loading_state, :n_clicks, :n_clicks_timestamp, :role, :spellCheck, :style, :tabIndex, :title]
