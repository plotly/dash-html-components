...
function html_param(; kwargs...)
        available_props = Symbol[:children, :id, :accessKey, :className, :contentEditable, :contextMenu, :dir, :draggable, :hidden, :key, :lang, :loading_state, :n_clicks, :n_clicks_timestamp, :name, :role, :spellCheck, :style, :tabIndex, :title, :value]
