...
function html_option(; kwargs...)
        available_props = Symbol[:children, :id, :accessKey, :className, :contentEditable, :contextMenu, :dir, :disabled, :draggable, :hidden, :key, :label, :lang, :loading_state, :n_clicks, :n_clicks_timestamp, :role, :selected, :spellCheck, :style, :tabIndex, :title, :value]
