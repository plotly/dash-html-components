...
function html_footer(; kwargs...)
        ...
        return Component("html_footer", "Footer", "dash_html_components", available_props, wild_props; kwargs...)
end

html_footer(children::Any; kwargs...) = html_footer(;kwargs..., children = children)
