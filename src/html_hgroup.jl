...
function html_hgroup(; kwargs...)
        ...
        return Component("html_hgroup", "Hgroup", "dash_html_components", available_props, wild_props; kwargs...)
end

html_hgroup(children::Any; kwargs...) = html_hgroup(;kwargs..., children = children)
