...
function html_figcaption(; kwargs...)
        ...
        return Component("html_figcaption", "Figcaption", "dash_html_components", available_props, wild_props; kwargs...)
end

html_figcaption(children::Any; kwargs...) = html_figcaption(;kwargs..., children = children)
