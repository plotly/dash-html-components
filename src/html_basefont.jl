...
function html_basefont(; kwargs...)
        ...
        return Component("html_basefont", "Basefont", "dash_html_components", available_props, wild_props; kwargs...)
end

html_basefont(children::Any; kwargs...) = html_basefont(;kwargs..., children = children)
