...
function html_legend(; kwargs...)
        ...
        return Component("html_legend", "Legend", "dash_html_components", available_props, wild_props; kwargs...)
end

html_legend(children::Any; kwargs...) = html_legend(;kwargs..., children = children)
