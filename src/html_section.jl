...
function html_section(; kwargs...)
        ...
        return Component("html_section", "Section", "dash_html_components", available_props, wild_props; kwargs...)
end

html_section(children::Any; kwargs...) = html_section(;kwargs..., children = children)
