...
function html_summary(; kwargs...)
        ...
        return Component("html_summary", "Summary", "dash_html_components", available_props, wild_props; kwargs...)
end

html_summary(children::Any; kwargs...) = html_summary(;kwargs..., children = children)
