...
function html_title(; kwargs...)
        ...
        return Component("html_title", "Title", "dash_html_components", available_props, wild_props; kwargs...)
end

html_title(children::Any; kwargs...) = html_title(;kwargs..., children = children)
