...
function html_header(; kwargs...)
        ...
        return Component("html_header", "Header", "dash_html_components", available_props, wild_props; kwargs...)
end

html_header(children::Any; kwargs...) = html_header(;kwargs..., children = children)
