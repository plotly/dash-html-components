...
function html_cite(; kwargs...)
        ...
        return Component("html_cite", "Cite", "dash_html_components", available_props, wild_props; kwargs...)
end

html_cite(children::Any; kwargs...) = html_cite(;kwargs..., children = children)
