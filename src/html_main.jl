...
function html_main(; kwargs...)
        ...
        return Component("html_main", "Main", "dash_html_components", available_props, wild_props; kwargs...)
end

html_main(children::Any; kwargs...) = html_main(;kwargs..., children = children)
