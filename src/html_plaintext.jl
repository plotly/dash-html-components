...
function html_plaintext(; kwargs...)
        ...
        return Component("html_plaintext", "Plaintext", "dash_html_components", available_props, wild_props; kwargs...)
end

html_plaintext(children::Any; kwargs...) = html_plaintext(;kwargs..., children = children)
