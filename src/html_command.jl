...
function html_command(; kwargs...)
        available_props = Symbol[:children, :id, :accessKey, :checked, :className, :contentEditable, :contextMenu, :dir, :disabled, :draggable, :hidden, :icon, :key, :lang, :loading_state, :n_clicks, :n_clicks_timestamp, :radioGroup, :role, :spellCheck, :style, :tabIndex, :title, :type]
