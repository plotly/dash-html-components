...
function html_strike(; kwargs...)
        ...
        return Component("html_strike", "Strike", "dash_html_components", available_props, wild_props; kwargs...)
end

html_strike(children::Any; kwargs...) = html_strike(;kwargs..., children = children)
