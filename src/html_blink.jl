...
function html_blink(; kwargs...)
        ...
        return Component("html_blink", "Blink", "dash_html_components", available_props, wild_props; kwargs...)
end

html_blink(children::Any; kwargs...) = html_blink(;kwargs..., children = children)
