...
function html_listing(; kwargs...)
        ...
        return Component("html_listing", "Listing", "dash_html_components", available_props, wild_props; kwargs...)
end

html_listing(children::Any; kwargs...) = html_listing(;kwargs..., children = children)
