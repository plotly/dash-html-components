...
function html_colgroup(; kwargs...)
        available_props = Symbol[:children, :id, :n_clicks, :n_clicks_timestamp, :key, :role, :span, :accessKey, :className, :contentEditable, :contextMenu, :dir, :draggable, :hidden, :lang, :spellCheck, :style, :tabIndex, :title, :loading_state]
        wild_props = Symbol[Symbol("data-"), Symbol("aria-")]
        return Component("html_colgroup", "Colgroup", "dash_html_components", available_props, wild_props; kwargs...)
end

html_colgroup(children::Any; kwargs...) = html_colgroup(;kwargs..., children = children)
