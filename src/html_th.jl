...
function html_th(; kwargs...)
        available_props = Symbol[:children, :id, :accessKey, :className, :colSpan, :contentEditable, :contextMenu, :dir, :draggable, :headers, :hidden, :key, :lang, :loading_state, :n_clicks, :n_clicks_timestamp, :role, :rowSpan, :scope, :spellCheck, :style, :tabIndex, :title]
