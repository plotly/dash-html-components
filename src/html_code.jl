...
function html_code(; kwargs...)
        ...
        return Component("html_code", "Code", "dash_html_components", available_props, wild_props; kwargs...)
end

html_code(children::Any; kwargs...) = html_code(;kwargs..., children = children)
