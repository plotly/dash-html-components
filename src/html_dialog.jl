...
function html_dialog(; kwargs...)
        ...
        return Component("html_dialog", "Dialog", "dash_html_components", available_props, wild_props; kwargs...)
end

html_dialog(children::Any; kwargs...) = html_dialog(;kwargs..., children = children)
