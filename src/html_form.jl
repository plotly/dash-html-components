...
function html_form(; kwargs...)
        available_props = Symbol[:children, :id, :accept, :acceptCharset, :accessKey, :action, :autoComplete, :className, :contentEditable, :contextMenu, :dir, :draggable, :encType, :hidden, :key, :lang, :loading_state, :method, :n_clicks, :n_clicks_timestamp, :name, :noValidate, :role, :spellCheck, :style, :tabIndex, :target, :title]
