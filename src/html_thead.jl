...
function html_thead(; kwargs...)
        ...
        return Component("html_thead", "Thead", "dash_html_components", available_props, wild_props; kwargs...)
end

html_thead(children::Any; kwargs...) = html_thead(;kwargs..., children = children)
