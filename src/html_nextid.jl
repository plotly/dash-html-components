...
function html_nextid(; kwargs...)
        ...
        return Component("html_nextid", "Nextid", "dash_html_components", available_props, wild_props; kwargs...)
end

html_nextid(children::Any; kwargs...) = html_nextid(;kwargs..., children = children)
