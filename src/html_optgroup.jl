...
function html_optgroup(; kwargs...)
        available_props = Symbol[:children, :id, :n_clicks, :n_clicks_timestamp, :key, :role, :disabled, :label, :accessKey, :className, :contentEditable, :contextMenu, :dir, :draggable, :hidden, :lang, :spellCheck, :style, :tabIndex, :title, :loading_state]
        wild_props = Symbol[Symbol("data-"), Symbol("aria-")]
        return Component("html_optgroup", "Optgroup", "dash_html_components", available_props, wild_props; kwargs...)
end

html_optgroup(children::Any; kwargs...) = html_optgroup(;kwargs..., children = children)
