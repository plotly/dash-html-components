...
function html_aside(; kwargs...)
        ...
        return Component("html_aside", "Aside", "dash_html_components", available_props, wild_props; kwargs...)
end

html_aside(children::Any; kwargs...) = html_aside(;kwargs..., children = children)
