...
function html_spacer(; kwargs...)
        ...
        return Component("html_spacer", "Spacer", "dash_html_components", available_props, wild_props; kwargs...)
end

html_spacer(children::Any; kwargs...) = html_spacer(;kwargs..., children = children)
