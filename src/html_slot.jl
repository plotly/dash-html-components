...
function html_slot(; kwargs...)
        ...
        return Component("html_slot", "Slot", "dash_html_components", available_props, wild_props; kwargs...)
end

html_slot(children::Any; kwargs...) = html_slot(;kwargs..., children = children)
