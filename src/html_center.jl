...
function html_center(; kwargs...)
        ...
        result = Component("Center", "dash_html_components", Dict{Symbol, Any}(), available_props, Set(Symbol[Symbol("data-"), Symbol("aria-")]))
...
function html_center(children::Any; kwargs...)
    result = html_center(;kwargs...)
    push!(result.props, :children => Front.to_dash(children))
    return result
end

html_center(children_maker::Function; kwargs...) = html_center(children_maker(); kwargs...)
