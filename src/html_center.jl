...
function html_center(; kwargs...)
        ...
        return Component("html_center", "Center", "dash_html_components", available_props, wild_props; kwargs...)
end

html_center(children::Any; kwargs...) = html_center(;kwargs..., children = children)
