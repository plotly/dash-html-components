...
function html_font(; kwargs...)
        ...
        return Component("html_font", "Font", "dash_html_components", available_props, wild_props; kwargs...)
end

html_font(children::Any; kwargs...) = html_font(;kwargs..., children = children)
