...
function html_content(; kwargs...)
        ...
        return Component("html_content", "Content", "dash_html_components", available_props, wild_props; kwargs...)
end

html_content(children::Any; kwargs...) = html_content(;kwargs..., children = children)
