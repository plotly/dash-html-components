...
function html_datalist(; kwargs...)
        ...
        return Component("html_datalist", "Datalist", "dash_html_components", available_props, wild_props; kwargs...)
end

html_datalist(children::Any; kwargs...) = html_datalist(;kwargs..., children = children)
