...
function html_noscript(; kwargs...)
        ...
        return Component("html_noscript", "Noscript", "dash_html_components", available_props, wild_props; kwargs...)
end

html_noscript(children::Any; kwargs...) = html_noscript(;kwargs..., children = children)
