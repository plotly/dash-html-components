...
function html_tfoot(; kwargs...)
        ...
        return Component("html_tfoot", "Tfoot", "dash_html_components", available_props, wild_props; kwargs...)
end

html_tfoot(children::Any; kwargs...) = html_tfoot(;kwargs..., children = children)
