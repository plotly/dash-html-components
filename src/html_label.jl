...
function html_label(; kwargs...)
        available_props = Symbol[:children, :id, :n_clicks, :n_clicks_timestamp, :key, :role, :htmlFor, :form, :accessKey, :className, :contentEditable, :contextMenu, :dir, :draggable, :hidden, :lang, :spellCheck, :style, :tabIndex, :title, :loading_state]
        wild_props = Symbol[Symbol("data-"), Symbol("aria-")]
        return Component("html_label", "Label", "dash_html_components", available_props, wild_props; kwargs...)
end

html_label(children::Any; kwargs...) = html_label(;kwargs..., children = children)
