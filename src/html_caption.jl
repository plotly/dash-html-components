...
function html_caption(; kwargs...)
        ...
        return Component("html_caption", "Caption", "dash_html_components", available_props, wild_props; kwargs...)
end

html_caption(children::Any; kwargs...) = html_caption(;kwargs..., children = children)
