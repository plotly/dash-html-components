...
function html_frameset(; kwargs...)
        ...
        return Component("html_frameset", "Frameset", "dash_html_components", available_props, wild_props; kwargs...)
end

html_frameset(children::Any; kwargs...) = html_frameset(;kwargs..., children = children)
