...
schema = {'accessKey': {'type': 'string'}, 'value': {'type': 'string'}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['click']}, 'n_clicks_timestamp': {}, 'style': {'type': 'dict'}, 'contextMenu': {'type': 'string'}, 'hidden': {'type': 'string'}, 'fireEvent': {}, 'form': {'type': 'string'}, 'id': {'type': 'string'}, 'dir': {'type': 'string'}, 'draggable': {'type': 'string'}, 'className': {'type': 'string'}, 'n_clicks': {}, 'children': {'anyof': [{'type': 'component'}, {'type': 'boolean'}, {'type': 'number'}, {'type': 'string'}, {'type': 'list', 'schema': {'type': ('component', 'boolean', 'number', 'string')}}]}, 'max': {'type': 'string'}, 'title': {'type': 'string'}, 'key': {'type': 'string'}, 'spellCheck': {'type': 'string'}, 'lang': {'type': 'string'}, 'role': {'type': 'string'}, 'tabIndex': {'type': 'string'}, 'contentEditable': {'type': 'string'}}
