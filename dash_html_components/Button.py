...
schema = {'role': {'type': 'string'}, 'spellCheck': {'type': 'string'}, 'autoFocus': {'type': 'string'}, 'className': {'type': 'string'}, 'value': {'type': 'string'}, 'dashEvents': {'allowed': ['click'], 'type': ('string', 'number')}, 'hidden': {'type': 'string'}, 'formAction': {'type': 'string'}, 'lang': {'type': 'string'}, 'key': {'type': 'string'}, 'style': {'type': 'dict'}, 'fireEvent': {}, 'type': {'type': 'string'}, 'contentEditable': {'type': 'string'}, 'tabIndex': {'type': 'string'}, 'name': {'type': 'string'}, 'dir': {'type': 'string'}, 'n_clicks': {}, 'n_clicks_timestamp': {}, 'contextMenu': {'type': 'string'}, 'form': {'type': 'string'}, 'draggable': {'type': 'string'}, 'disabled': {'type': 'string'}, 'children': {'nullable': True, 'anyof': [{'type': 'string'}, {'type': 'number'}, {'type': 'boolean'}, {'type': 'component'}, {'nullable': True, 'allowed': [None], 'type': ('string', 'number')}, {'schema': {'nullable': True, 'anyof': [{'type': 'string'}, {'type': 'number'}, {'type': 'boolean'}, {'type': 'component'}, {'nullable': True, 'allowed': [None], 'type': ('string', 'number')}]}, 'type': 'list'}]}, 'id': {'type': 'string'}, 'accessKey': {'type': 'string'}, 'title': {'type': 'string'}}
