...
class Select(DashComponent):
    ...
    def __init__(
        ...
        :param multiple: Indicates whether multiple values can be entered
            in an input of the type email or file.
        ...
        :param required: Indicates whether this element is required to fill
            out or not.
        :param size: Defines the width of the element (in pixels). If the
            element's type attribute is text or password then it's
