...
class Iframe(DashComponent):
    ...
    sandbox = ComponentProp('sandbox', UNDEFINED, False)
    src = ComponentProp('src', UNDEFINED, False)
    srcDoc = ComponentProp('srcDoc', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param sandbox: Stops a document loaded in an iframe from using
