...
class Meter(DashComponent):
    ...
    high = ComponentProp('high', UNDEFINED, False)
    low = ComponentProp('low', UNDEFINED, False)
    max = ComponentProp('max', UNDEFINED, False)
    min = ComponentProp('min', UNDEFINED, False)
    optimum = ComponentProp('optimum', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param value: Defines a default value which will be displayed in
            the element on page load.
