...
class Img(DashComponent):
    ...
    srcSet = ComponentProp('srcSet', UNDEFINED, False)
    useMap = ComponentProp('useMap', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param srcSet: One or more responsive image candidates.
        :param useMap:
        :param width: For the elements listed here, this establishes the
            element's width.
            Note: For all other instances, such as <div>, this is
            a legacy attribute, in which case the CSS width
            property should be used instead.
