...
class Form(DashComponent):
    ...
    acceptCharset = ComponentProp('acceptCharset', UNDEFINED, False)
    action = ComponentProp('action', UNDEFINED, False)
    autoComplete = ComponentProp('autoComplete', UNDEFINED, False)
    encType = ComponentProp('encType', UNDEFINED, False)
    method = ComponentProp('method', UNDEFINED, False)
    name = ComponentProp('name', UNDEFINED, False)
    noValidate = ComponentProp('noValidate', UNDEFINED, False)
    target = ComponentProp('target', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param n_clicks: An integer that represents the number of times
            that this element has been clicked on.(default=0)
        ...
        :param accept: List of types the server accepts, typically a file
            type.
        :param acceptCharset: List of supported charsets.
        :param action: The URI of a program that processes the information
            submitted via the form.
        :param autoComplete: Indicates whether controls in this form can by
            default have their values automatically
            completed by the browser.
        :param encType: Defines the content type of the form date when the
            method is POST.
        :param method: Defines which HTTP method to use when submitting the
            form. Can be GET (default) or POST.
        :param name: Name of the element. For example used by the server to
            identify the fields in form submits.
        :param noValidate: This attribute indicates that the form shouldn't
