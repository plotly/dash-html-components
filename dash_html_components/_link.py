...
class Link(DashComponent):
    ...
    integrity = ComponentProp('integrity', UNDEFINED, False)
    media = ComponentProp('media', UNDEFINED, False)
    rel = ComponentProp('rel', UNDEFINED, False)
    sizes = ComponentProp('sizes', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param integrity: Security Feature that allows browsers to verify
            what they fetch.
