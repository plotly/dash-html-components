...
class Command(DashComponent):
    ...
    checked = ComponentProp('checked', UNDEFINED, False)
    disabled = ComponentProp('disabled', UNDEFINED, False)
    icon = ComponentProp('icon', UNDEFINED, False)
    radioGroup = ComponentProp('radioGroup', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param checked: Indicates whether the element should be checked on
            page load.
