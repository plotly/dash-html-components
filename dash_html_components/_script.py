...
class Script(DashComponent):
    ...
    charSet = ComponentProp('charSet', UNDEFINED, False)
    crossOrigin = ComponentProp('crossOrigin', UNDEFINED, False)
    defer = ComponentProp('defer', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param charSet: Declares the character encoding of the page or
            script.
        :param crossOrigin: How the element handles cross-origin requests
        :param defer: Indicates that the script should be executed after
