...
class Keygen(DashComponent):
    ...
    challenge = ComponentProp('challenge', UNDEFINED, False)
    disabled = ComponentProp('disabled', UNDEFINED, False)
    form = ComponentProp('form', UNDEFINED, False)
    keyType = ComponentProp('keyType', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param autoFocus: The element should be automatically focused after
            the page loaded.
        :param challenge: A challenge string that is submitted along with
            the public key.
