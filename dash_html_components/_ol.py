...
class Ol(DashComponent):
    ...
    reversed = ComponentProp('reversed', UNDEFINED, False)
    start = ComponentProp('start', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param reversed: Indicates whether the list should be displayed in
            a descending order instead of a ascending.
