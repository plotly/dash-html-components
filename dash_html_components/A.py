...
schema = {'media': {'type': 'string'}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['click']}, 'download': {'type': 'string'}, 'n_clicks_timestamp': {}, 'style': {'type': 'dict'}, 'contextMenu': {'type': 'string'}, 'key': {'type': 'string'}, 'target': {'type': 'string'}, 'hidden': {'type': 'string'}, 'href': {'type': 'string'}, 'id': {'type': 'string'}, 'dir': {'type': 'string'}, 'draggable': {'type': 'string'}, 'className': {'type': 'string'}, 'n_clicks': {}, 'children': {'anyof': [{'type': 'component'}, {'type': 'boolean'}, {'type': 'number'}, {'type': 'string'}, {'type': 'list', 'schema': {'type': ('component', 'boolean', 'number', 'string')}}]}, 'fireEvent': {}, 'accessKey': {'type': 'string'}, 'title': {'type': 'string'}, 'hrefLang': {'type': 'string'}, 'spellCheck': {'type': 'string'}, 'lang': {'type': 'string'}, 'role': {'type': 'string'}, 'tabIndex': {'type': 'string'}, 'rel': {'type': 'string'}, 'contentEditable': {'type': 'string'}, 'shape': {'type': 'string'}}
