...
class Meta(DashComponent):
    ...
    content = ComponentProp('content', UNDEFINED, False)
    httpEquiv = ComponentProp('httpEquiv', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param charSet: Declares the character encoding of the page or
            script.
        :param content: A value associated with http-equiv or name
            depending on the context.
        :param httpEquiv: Defines a pragma directive.
