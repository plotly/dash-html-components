...
class Ins(DashComponent):
    ...
    cite = ComponentProp('cite', UNDEFINED, False)
    dateTime = ComponentProp('dateTime', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param cite: Contains a URI which points to the source of the quote
            or change.
        :param dateTime: Indicates the date and time associated with the
            element.
