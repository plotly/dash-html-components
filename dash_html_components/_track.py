...
class Track(DashComponent):
    ...
    default = ComponentProp('default', UNDEFINED, False)
    kind = ComponentProp('kind', UNDEFINED, False)
    label = ComponentProp('label', UNDEFINED, False)
    src = ComponentProp('src', UNDEFINED, False)
    srcLang = ComponentProp('srcLang', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param default: Indicates that the track should be enabled unless
            the user's preferences indicate something
            different.
