...
class Th(DashComponent):
    ...
    colSpan = ComponentProp('colSpan', UNDEFINED, False)
    headers = ComponentProp('headers', UNDEFINED, False)
    rowSpan = ComponentProp('rowSpan', UNDEFINED, False)
    scope = ComponentProp('scope', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param colSpan: The colspan attribute defines the number of columns
            a cell should span.
        :param headers: IDs of the <th> elements which applies to this
            element.
        :param rowSpan: Defines the number of rows a table cell should span
            over.
        :param scope: Defines the cells that the header test (defined in
            the th element) relates to.
