...
schema = {'role': {'type': 'string'}, 'className': {'type': 'string'}, 'dateTime': {'type': 'string'}, 'hidden': {'type': 'string'}, 'spellCheck': {'type': 'string'}, 'lang': {'type': 'string'}, 'contentEditable': {'type': 'string'}, 'key': {'type': 'string'}, 'style': {'type': 'dict'}, 'fireEvent': {}, 'id': {'type': 'string'}, 'tabIndex': {'type': 'string'}, 'dir': {'type': 'string'}, 'n_clicks': {}, 'contextMenu': {'type': 'string'}, 'cite': {'type': 'string'}, 'n_clicks_timestamp': {}, 'draggable': {'type': 'string'}, 'dashEvents': {'allowed': ['click'], 'type': ('string', 'number')}, 'children': {'nullable': True, 'anyof': [{'type': 'string'}, {'type': 'number'}, {'type': 'boolean'}, {'type': 'component'}, {'nullable': True, 'allowed': [None], 'type': ('string', 'number')}, {'schema': {'nullable': True, 'anyof': [{'type': 'string'}, {'type': 'number'}, {'type': 'boolean'}, {'type': 'component'}, {'nullable': True, 'allowed': [None], 'type': ('string', 'number')}]}, 'type': 'list'}]}, 'accessKey': {'type': 'string'}, 'title': {'type': 'string'}}
