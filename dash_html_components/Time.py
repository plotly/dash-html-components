...
schema = {'role': {'type': 'string'}, 'tabIndex': {'type': 'string'}, 'className': {'type': 'string'}, 'dir': {'type': 'string'}, 'n_clicks': {}, 'dateTime': {'type': 'string'}, 'hidden': {'type': 'string'}, 'spellCheck': {'type': 'string'}, 'contextMenu': {'type': 'string'}, 'n_clicks_timestamp': {}, 'key': {'type': 'string'}, 'draggable': {'type': 'string'}, 'lang': {'type': 'string'}, 'dashEvents': {'allowed': ['click'], 'type': ('string', 'number')}, 'style': {'type': 'dict'}, 'children': {'nullable': True, 'anyof': [{'type': 'string'}, {'type': 'number'}, {'type': 'boolean'}, {'type': 'component'}, {'nullable': True, 'allowed': [None], 'type': ('string', 'number')}, {'schema': {'nullable': True, 'anyof': [{'type': 'string'}, {'type': 'number'}, {'type': 'boolean'}, {'type': 'component'}, {'nullable': True, 'allowed': [None], 'type': ('string', 'number')}]}, 'type': 'list'}]}, 'fireEvent': {}, 'id': {'type': 'string'}, 'accessKey': {'type': 'string'}, 'title': {'type': 'string'}, 'contentEditable': {'type': 'string'}}
