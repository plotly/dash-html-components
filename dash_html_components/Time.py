...
schema = {'className': {'type': 'string'}, 'n_clicks': {}, 'children': {'anyof': [{'type': 'component'}, {'type': 'boolean'}, {'type': 'number'}, {'type': 'string'}, {'type': 'list', 'schema': {'type': ('component', 'boolean', 'number', 'string')}}]}, 'style': {'type': 'dict'}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['click']}, 'dateTime': {'type': 'string'}, 'n_clicks_timestamp': {}, 'contentEditable': {'type': 'string'}, 'key': {'type': 'string'}, 'contextMenu': {'type': 'string'}, 'title': {'type': 'string'}, 'lang': {'type': 'string'}, 'hidden': {'type': 'string'}, 'role': {'type': 'string'}, 'fireEvent': {}, 'tabIndex': {'type': 'string'}, 'spellCheck': {'type': 'string'}, 'id': {'type': 'string'}, 'accessKey': {'type': 'string'}, 'dir': {'type': 'string'}, 'draggable': {'type': 'string'}}
