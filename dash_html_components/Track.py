...
schema = {'default': {'type': 'string'}, 'n_clicks_timestamp': {}, 'style': {'type': 'dict'}, 'contextMenu': {'type': 'string'}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['click']}, 'hidden': {'type': 'string'}, 'tabIndex': {'type': 'string'}, 'src': {'type': 'string'}, 'id': {'type': 'string'}, 'dir': {'type': 'string'}, 'draggable': {'type': 'string'}, 'className': {'type': 'string'}, 'n_clicks': {}, 'children': {'anyof': [{'type': 'component'}, {'type': 'boolean'}, {'type': 'number'}, {'type': 'string'}, {'type': 'list', 'schema': {'type': ('component', 'boolean', 'number', 'string')}}]}, 'fireEvent': {}, 'label': {'type': 'string'}, 'accessKey': {'type': 'string'}, 'title': {'type': 'string'}, 'kind': {'type': 'string'}, 'key': {'type': 'string'}, 'spellCheck': {'type': 'string'}, 'srcLang': {'type': 'string'}, 'role': {'type': 'string'}, 'lang': {'type': 'string'}, 'contentEditable': {'type': 'string'}}
