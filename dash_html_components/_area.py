...
class Area(DashComponent):
    ...
    alt = ComponentProp('alt', UNDEFINED, False)
    coords = ComponentProp('coords', UNDEFINED, False)
    download = ComponentProp('download', UNDEFINED, False)
    href = ComponentProp('href', UNDEFINED, False)
    hrefLang = ComponentProp('hrefLang', UNDEFINED, False)
    media = ComponentProp('media', UNDEFINED, False)
    rel = ComponentProp('rel', UNDEFINED, False)
    shape = ComponentProp('shape', UNDEFINED, False)
    ...
    def __init__(
        ...
        :param coords: A set of values specifying the coordinates of the
            hot-spot region.
        :param download: Indicates that the hyperlink is to be used for
            downloading a resource.
        :param href: The URL of a linked resource.
        :param hrefLang: Specifies the language of the linked resource.
        :param media: Specifies a hint of the media for which the linked
            resource was designed.
        :param rel: Specifies the relationship of the target object to the
            link object.
        :param shape:
        :param target:
